...
%     end
    ...
    properties (Constant, Hidden)
        ...
        apiSupportedVersionNames = {'8.8' '9.3.x' '9.6.x', '9.8.x', '17.0.x', '17.1.x', '18.6.x'}; %A list of shorthand names for API versions supported by this wrapper class
    ...
    methods (Hidden)
        function apiCurrentVersion = apiVersionDetectHookFcn(obj)
            ...
            try
                ...
                versionNum2NameMap(17.0) = '17.0.x';
                versionNum2NameMap(17.1) = '17.1.x';
                versionNum2NameMap(18.6) = '18.6.x';
...
hMap('17.0.x') = 'NIDAQmx_proto.m';
hMap('17.1.x') = 'NIDAQmx_proto.m';
hMap('18.6.x') = 'NIDAQmx_proto.m';
...
p = fullfile(most.idioms.startPath,pfDir,'national instruments','ni-daq','daqmx ansi c dev','include');
