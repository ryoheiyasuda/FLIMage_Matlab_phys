classdef APIWrapper < most.DClass
    ...
    methods
        function obj = APIWrapper()
            ...
            function ziniSetDefaultValues()
                ...
                defaultValMap('apiAuxFile1Paths') = obj.classPrivatePath;
                defaultValMap('apiAuxFile2Names') = '';
                defaultValMap('apiAuxFile2Paths') = obj.classPrivatePath;
                
                %Handle apiDLLPath default -- can be specified in MDF
                if ~isa(obj,'most.MachineDataFile') || ~isfield(obj.mdfData,'apiDLLPath')
                    defaultVal = '';
                else
                ...
                switch obj.apiHeaderRootPath
                    case 'class'
                        obj.apiHeaderRootPath = obj.classPrivatePath;
                    case 'package'
                        obj.apiHeaderRootPath = obj.packagePrivatePath;
                    otherwise
                        % "real path", no-op.
                end
            ...
            function ziniGetAPICurrentVersion()
                ...
                if isa(obj,'most.MachineDataFile')
    ...
    methods
        ...
        function val = get.apiDataFullFileName(obj)
            ...
            if isempty(obj.apiCachedDataPath)
                cachedDataPath = obj.classPrivatePath;
            else
    ...
    methods (Hidden)
        ...
        function apiProcessErrorResponseCode(obj, responseCode, funcName)
            ...
            if warningOnly
                ...
                warning([obj.classNameShort ':APICallWarning'],errorString);
                warning(s.state, 'backtrace');
            else
                ME = MException([obj.classNameShort ':APICallError'],errorString);
                ME.throwAsCaller();
            end
    ...
    methods (Static, Access=protected)
        ...
        function val = apiCachedDataPathStatic(className)
            ...
            if isempty(apiCachedDataPathSpec)
                val = most.DClass.classPrivatePathStatic(className);
            else
